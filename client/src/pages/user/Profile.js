...
const Profile = () => {
    ...
    const handleSave = () => {
        const updatedData = {
            firstName: formatName(updatedFirstName),
            lastName: formatName(updatedLastName),
            email: updatedEmail,
            phone: updatedPhone
        };
                            ...
                            <div className="flex flex-col w-full">
                              <div className='text-center'>
                                <input
                                  ...
                                  onChange={(e) => setUpdatedFirstName(e.target.value.trim())}
                                  name="firstName"
                                  placeholder="First Name"
                                  className="border-2 border-gray-300 rounded mb-3 p-2 focus:border-blue-500 focus:outline-none mx-1"
                                />
                                <input
                                  ...
                                  onChange={(e) => setUpdatedLastName(e.target.value.trim())}
                                  name="lastName"
                                  placeholder="Last Name"
                                  className="border-2 border-gray-300 rounded mb-3 p-2 focus:border-blue-500 focus:outline-none mx-1"
                                />
                                ...
                                <input
                                  type="tel"
                                  value={updatedPhone}
                                  onChange={(e) => setUpdatedPhone(e.target.value.trim())}
                                  name="phone"
                                  placeholder="Phone Number"
                                  className="border-2 border-gray-300 rounded mb-3 p-2 focus:border-blue-500 focus:outline-none mx-1"
                                />
